...
function Mainpage() {
    ...
    const firstMenuItem = cart.length > 0 ? menus.find(m => m.menuId === cart[0].menuId) : null  // 담긴 첫번째 메뉴
  ...
  return (
    <div className='order-app'>
                        ...
                        <Link to={`/${menu.menuId}`} key={index} >
                            <div className='menu-item'>
                                ...
                                <div className='menu-purchaseButton'>
                                    <ShoppingCartOutlinedIcon sx={{ color: "rgb(10, 210, 137)"}}/>
        ...
        { totalQuantityRef.current[0] > 0 && <Bottombar totalCount={totalQuantityRef.current[0]} totalMoney={totalQuantityRef.current[1]} firstMenuItem={firstMenuItem} remainingItems={remainingItems}/> }
